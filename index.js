(() => {
  ...
  var concatAttr = function(v) {
    return function(v1) {
      return function(attrs) {
        ...
        ;
        throw new Error("Failed pattern match at Oak.VirtualDom (line 23, column 1 - line 28, column 16): " + [v.constructor.name, v1.constructor.name, attrs.constructor.name]);
      };
    };
  };
  ...
  var update = function(msg) {
    return function(model) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 30, column 20 - line 32, column 45): " + [msg.constructor.name]);
    };
  };
